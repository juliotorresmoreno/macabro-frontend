    ...
    <Fragment>
        <Row>
            ...
            <Col md={5}>
                ...
                <p className="text-justify">“Hemos reemplazado 14 aplicaciones diferentes y hemos aumentado las ganancias en un 10% de la noche a la mañana.”
                Marc Peeters, director general de la Divisón de Ventas.</p>
                <br />
            </Col>
        </Row>
    </Fragment>
